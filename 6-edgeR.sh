...
 
$TRINITY_HOME/util/misc/count_matrix_features_given_MIN_TPM_threshold.pl  Dip-ten_RSEM.isoform.TPM.not_cross_norm | tee Dip-ten_RSEM.qgenes_matrix.TPM.not_cross_

# Perform sample comparisons
$TRINITY_HOME/Analysis/DifferentialExpression/PtR --matrix Dip-ten_RSEM.isoform.counts.matrix --samples /mnt/scratch/sbi9srj/Lama/samples.txt --CPM --log2 --compare_replicates
 
$TRINITY_HOME/Analysis/DifferentialExpression/PtR --matrix Dip-ten_RSEM.isoform.counts.matrix -s /mnt/scratch/sbi9srj/Lama/samples.txt --log2 --sample_cor_matrix
 
$TRINITY_HOME/Analysis/DifferentialExpression/PtR --matrix Dip-ten_RSEM.isoform.counts.matrix -s /mnt/scratch/sbi9srj/Lama/samples.txt --log2 --prin_comp 3

#Differential analysis
$TRINITY_HOME/Analysis/DifferentialExpression/run_DE_analysis.pl --matrix Dip-ten_RSEM.isoform.counts.matrix --samples_file /mnt/scratch/sbi9srj/Lama/samples.txt --method edgeR --output edgeR_results
 
$TRINITY_HOME/Analysis/DifferentialExpression/analyze_diff_expr.pl --matrix Dip-ten_RSEM.isoform.TMM.EXPR.matrix -P 1e-3 -C 1.4 --samples /mnt/scratch/sbi9srj/Lama/samples.txt
